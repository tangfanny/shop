...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'pasteplain':'纯文本粘贴模式', 'selectall':'全选', 'print':'打印', 
    ...
    'insertimage':{
        'static':{
            ...
            'lang_savePath':'多图上传只支持5张，超过5张 后果自负!：',
    ...
    'help':{
        'static':{
            'lang_input_about':'word文档图片上传步骤',
            'lang_input_shortcuts':'快捷键',
            'lang_input_introduction':'选中图片区域->然后点击图片上传按钮->复制远程图片下地址栏的地址->选中本地上传->添加图片->Ctrl+V将地址粘贴至文件名后的空白区域->点击打开按钮后选择图片上传流程' ,
