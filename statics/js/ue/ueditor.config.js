...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"http://img.secwk.com/"     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imageFieldName:"file"                      //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                           //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:6000                   //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        ,filePath:"http://img.secwk.com/"                  //附件修正地址，同imagePath
        ...
        ,imageManagerPath:"http://img.secwk.com/"     //图片修正地址，同imagePath
        ...
        //word转存配置区
        //,wordImageUrl:URL + "http://up.qiniu.com/"             //word转存提交地址
        //,wordImagePath:URL + "http://img.secwk.com/"                       //
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'scrawl',  'music', 'attachment', 'map', 'gmap', 'insertframe','insertcode',  'pagebreak', 'template', 'background', '|',
