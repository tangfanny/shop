	...
	return {
		...
		order : function(order_status) {
			...
			_ajaxpost(_post, param, content);
                ...
                /* 订单确认 */
		reject : function(order_status,url,id,type) {
                        //var  url = "?m=goods&c=admin_order&a=setPact";
			...
			var param = {
				...
				order_status:order_status,
				order_sn : order.order_sn
				//action:'?m=goods&c=admin_order&a=ajaxpact'
			};		
			switch (order_status){
				case 1:
					content = '是否确认合同信息无误';
