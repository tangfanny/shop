...
<div class="content">
    ...
    <div class="login mt10" style="border: none;">
        <table id="skill_lists" style="width:100%;height:auto"></table>
    </div>
    <div class="clear"></div>
...
<script type="text/javascript">
    var dom = $('#skill_lists');
    var dataurl = '<?php echo U('skill_child')?>';
    ...
    $(function(){
        dom.treegrid({
            ...
            columns:[[
                {field:'name',title:'技能名称',width:'40%',halign:'center',align:'left'},
                {field:'app_name',title:'APP名称',width:'20%',halign:'center',align:'left'},
//				{field:'grade',title:'价格分级',width:'20%',halign:'center',align:'left'},
                {field:'sort',title:'技能排序',width:'10%',halign:'center',align:'center',
    ...
    function batch(row){
        $.messager.confirm('确认','您确认想要删除所选择技能吗？',function(r){
            if(r){
