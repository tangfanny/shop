...
<div class="content">
	...
	<div class="goods mt10">
		<div class="search_ind">
			...
			<input id="keyword" class="easyui-textbox" name="keyword" style="width:210px;height: 26px;" prompt="输入用户姓名/手机/EMAIL">
			<a id="search" href="#" class="easyui-linkbutton" style="height: 26px;padding-right: 10px;">查询</a>
		</div>
		<dl class="mt10">
			<dt><p>
				<a href="<?php echo  U('lists?type=-1')?>" <?php if ($type == -1) { echo "class='hover'"; }; ?> > 全部会员认证</a>
				<a href="<?php echo  U('lists?type=1')?>"  <?php if ($type == 1) { echo "class='hover'"; }; ?>>白帽子认证</a>
...
//			],
			...
			//可以设置每页记录条数的列表 
			columns:[[
			{field:'mobile',title:'电话/email',width:'10%',halign:'center',align:'center'},
...
//				}
//			},
			{field:'nikename',title:'昵称',width:'11%',halign:'center',align:'center',sortable:true},
                        {field:'name',title:'姓名',width:'15%',halign:'center',align:'center',sortable:true},
                        {field:'roles',title:'用户角色',width:'15%',halign:'center',align:'center',sortable:true},
                        {field:'identity',title:'身份证号码',width:'13%',halign:'center',align:'center',sortable:true},
                        {field:'create_time',title:'创建时间',width:'13%',align:'center',sortable:true,
					formatter:function(value,row,index){
                        ...
                        {field:'roles_flag',title:'认证状态',width:'13%',halign:'center',align:'center',sortable:true},
...
//					try{
//						if(value == 1){
//							delivery_text = '<img width="52" height="18" src="'+imgpach+'/admin/ico_pay_'+value+'.png"" />';
//						}else if(value==0){
//							delivery_text = '<img width="52" height="18"   src="'+imgpach+'/admin/ico_pay_'+value+'.png"" />';
//						}else{
//                                                   delivery_text = '-'; 
...
//			},
			{field:'none',title:'操作',width:'8%',halign:'center',align:'center',
				formatter:function(value,row,index){
					var viewthtml = '<a href="'+editurl+'&id='+row.id+'&is_whitehat_auth='+row.is_whitehat_auth+'&is_company_auth='+row.is_company_auth+'&is_saler_auth='+row.is_saler_auth+'">审核</a>';
					return viewthtml ;
				}
			}
			]]
