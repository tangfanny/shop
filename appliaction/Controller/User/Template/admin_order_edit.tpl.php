                    ...
                    <?php  foreach ($info['order_staging'] as $key => $r): ?>
                        <tr>
                            ...
                            <td><?php if(is_numeric($r["remit_url"]) && strlen($r["remit_url"])==18):?>
                                    <a target="_blank" href="<?php echo IMG_URL.Img_ADDRESS.$r["remit_url"].'?imageView2/2/w/200 ';?>">查看凭证</a>
                                <?php elseif(empty($r["remit_url"])): ?>
                                    未上传凭证
                                    <?php else: ?>
                                    <a target="_blank" href="<?php echo IMG_URL.$r["remit_url"].'?imageView2/2/w/200 ';?>">查看凭证</a>
                                <?php endif;?>
                            </td>
                        </tr>
                    <?php endforeach ?>
            ...
            <dd>
                <table>
                    ...
                    <?php foreach ($info['order_pact'] as $key => $r): ?>
                        <tr>
                            <td><?php if(is_numeric($r["pact_url"]) && strlen($r["pact_url"])==18):?>
                                    <a target="_blank" href="<?php echo IMG_URL.Img_ADDRESS.$r["pact_url"].'?imageView2/2/w/200 '."/is_admin/1";?>">查看合同</a>
                                <?php elseif(empty($r["pact_url"])): ?>
                                    官方合同未上传
                                    <?php else: ?>
                                    <a target="_blank" href="<?php echo IMG_URL.$r["pact_url"].'?imageView2/2/w/200 ';?>">查看官方合同</a>
                                <?php endif;?>
                            </td>
                            ...
                            <td><?php if(is_numeric($r["official_pact_url"]) && strlen($r["official_pact_url"])==18):?>
                                    <a target="_blank" href="<?php echo IMG_URL.Img_ADDRESS.$r["official_pact_url"].'?imageView2/2/w/200 ';?>">查看合同</a>
                                <?php elseif(empty($r["official_pact_url"])): ?>
                                    官方合同未上传
                                    <?php else: ?>
                                    <a target="_blank" href="<?php echo IMG_URL.$r["official_pact_url"].'?imageView2/2/w/200 ';?>">查看合同</a>
                                <?php endif;?>
                            </td>
                            <!--                       <td>
