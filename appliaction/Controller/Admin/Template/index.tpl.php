...
<body>
<div class="header">
    <div class="logo fl" style="margin-left: 110px;"><!--img src="--><?php //echo IMG_PATH; ?><!--admin/logo.png" width="160" height="21" alt="" /--></div>
    <div class="menu-box">
        <div class="menu-left-bg"></div>
        <div class="menu fl">
            <?php
            foreach ($this->topMenu['topmenu'] as $key => $tmo) {
                if($tmo["id"]!=7&&$tmo["id"]!=8){//屏蔽部分菜单
    ...
    <div class="help">
        ...
        <a href="http://www.secwk.com/"><img src="<?php echo IMG_PATH; ?>admin/ico_2.png" alt="" />帮助</a>
    </div>
    <div class="clear"></div>
    <div class="welcome">
        ...
        <a href="<?php echo __API__NEW__ ?>" target="_blank">网站前台</a>|
...
//        $notshow = array(13,30,31,34,49,50,51,52);
...
//            print_r($mo);
            if(in_array($mo['id'], $notshow)){
                echo "<li><a href='javascript:;' name='disabled' class='z_side disabled'>".str_replace('&HR', '', $mo['name'])."</a></li>";
                   ...
                   echo "<li><a href='#' name='' data-attra=$mo[id] class='n1{$i} z_side {$mo['css']}' data='{$mo['url']}'>".str_replace('&HR', '', $mo['name'])."</a></li>"; 
            }
            //添加分隔线
