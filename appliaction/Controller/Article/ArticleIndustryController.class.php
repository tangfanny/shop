<?php
	 ...
	 *	  文章分类列表
	 */
class ArticleIndustryController extends AdminBaseController {

	public function _initialize() {
		parent::_initialize();	
		$this->db = model('IndustryCategory');
	}

	public function lists(){
		include $this->admin_tpl('article_industry_lists');
	}
	/**
	 * 列表
	 */
	...
	public function update(){
		...
		if(IS_POST){
			...
			if(isset($opt) && $opt){
				...
				include $this->admin_tpl('article_industry_update');
			}else{
 ...
 */
	public function findFather($pid){
		static $flist=array(); 
		$cate=model('Admin/Industry_category');
