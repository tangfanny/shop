...
<!--表格js-->
	...
	var editurl = '<?php echo U('update',array('opt'=>'updataflag'))?>';
	...
	$(function(){
		dom.datagrid({
			...
			columns:[[
				{field:'user_name',title:'名称',width:'15%',halign:'center',align:'center'},
				{field:'phone',title:'电话',width:'15%',halign:'center',align:'center'},
                                {field:'goods_name',title:'商品名称',width:'30%',halign:'center',align:'center'},
                                {field:'createtime',title:'点击时间',width:'10%',halign:'center',align:'center',sortable:true,
					formatter:function(value,row,index){
  						return $.fn.datebox.defaults.timeformat(value);
					}
				},
                                {field:'processing_time',title:'处理时间',width:'10%',halign:'center',align:'center',sortable:true,
					formatter:function(value,row,index){
                                            if(value!=0){
                                                return $.fn.datebox.defaults.timeformat(value);
                                            }else{
				...
				{field:'none',title:'编辑',width:'10%',halign:'center',align:'center',
					formatter:function(value,row,index){
                                            if(row.processing_flag==0){
                                                var edithtml = '<a href="'+editurl+'&id='+row.id+'">未查看</a>&nbsp;&nbsp;&nbsp;&nbsp;';
                                            }else{
                                                var edithtml="已查看&nbsp;&nbsp;&nbsp;&nbsp;";
                                            }
