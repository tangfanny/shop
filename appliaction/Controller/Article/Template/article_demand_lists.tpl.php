...
//				},'-'
			...
			columns:[[
				{field:'user_name',title:'名称',width:'5%',halign:'center',align:'center'},
				{field:'phone',title:'电话',width:'10%',halign:'center',align:'center'},
				{field:'email',title:'邮箱',width:'10%',halign:'center',align:'center'},
				{field:'category_id',title:'行业',width:'10%',halign:'center',align:'center'},
                                {field:'company_size',title:'公司规模',width:'5%',halign:'center',align:'center'
				},
                                {field:'description',title:'描述',width:'30%',halign:'center',align:'center'},
                                {field:'createtime',title:'申请时间',width:'15%',halign:'center',align:'center',sortable:true,
