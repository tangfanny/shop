		...
		dom.datagrid({
			...
			columns:[[
				...
				{field:'position_name',title:'广告类型',width:'15%',align:'center',sortable:true},
                                {field:'class_name',title:'产品分类',width:'15%',align:'center',sortable:true},
				{field:'type',title:'广告样式',width:'5%',align:'center',sortable:true,
				...
				{field:'hist',title:'点击次数',width:'5%',halign:'center',align:'center',sortable:true},
