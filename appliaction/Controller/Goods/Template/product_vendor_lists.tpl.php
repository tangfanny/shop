...
<!--表格js-->
	...
	$(function(){	
		dom.datagrid({   
			...
			columns:[[
				{field:'name',title:'服务厂商',width:'10%',halign:'center',align:'center'},
				{field:'sort',title:'厂商排序',width:'15%',align:'center',sortable:true,
				...
				{field:'value',title:'服务年限',width:'60%',halign:'center',align:'left',sortable:true},
