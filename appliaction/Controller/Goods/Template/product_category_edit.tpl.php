                            ...
                            <form action="<?php echo U('Product_category/edit')?>" class="addform" method="post">
                                <dd>
                                    <ul class="web">
                                        <li>
                                            <strong>名称：</strong>
                                            <input type="text" class="text_input" name="name" value="<?php echo $data['name'] ?>" placeholder='' datatype="*"/><span style="padding-left: 52px;" class="Validform_checktip ">请填写商品分类名称</span>
                                        </li>

                                        <li>
                                            <strong>APP名称：</strong>
                                            <input type="text" class="text_input" name="app_name" value="<?php echo $data['app_name'] ?>" placeholder='' datatype="*"/><span style="padding-left: 52px;" class="Validform_checktip ">请填写APP名称</span>
                                        </li>
                                        <li>
                                            <strong>App图片：</strong>
                                            <input type="file" class="am-hide" id="pickfiles" >
                                            <input type="hidden" id='chengxing' name="app_img" value="<?php echo $data['app_img'];?>">
                                            <div id="container">
                                            </div>
                                            <div>
                                        ...
                                        <li>
                                            ...
                                            <span style="padding-left: 52px;" class="Validform_checktip ">请输入App分类名称（0:空；1:广告页；2:商品页面；3:专题页面；4:资讯页面；5:众测页面；99:商品分类；）</span>
                                        </li>
                                        <li>
...
<!--                                        </li>-->
                                        ...
                                        <li>
                                            ...
                                            <input type="radio" name="app_flag" value="1" <?php echo ($data['app_flag'] == 1) ? 'checked' : ''; ?>/> 显示 <input type="radio" name="app_flag" value="0" <?php echo ($data['app_flag'] == 0) ? 'checked' : ''; ?>/> 禁用<span class="Validform_checktip"  style="margin-left:224px;">禁用导航，分类将不在前台导航中出现，默认为显示</span>
                                        </li>
                                        <li>
                                            <strong>状态：</strong>
