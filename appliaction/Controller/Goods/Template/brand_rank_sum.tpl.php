...
<script type="text/javascript">
    ...
    $(function(){
        dom.datagrid({
            ...
            //可以设置每页记录条数的列表
            columns:[[
                {field:'id',title:'排序',width:'19%',halign:'center',align:'center'},
                {field:'bid',title:'品牌名',width:'31%',halign:'center',align:'center',sortable:true,
                ...
                {field:'display_sale',title:'显示销量',width:'25%',halign:'center',align:'center',sortable:true},
                {field:'display_hit',title:'显示人气',width:'25%',halign:'center',align:'center',sortable:true}
//                {field:'sale_rate',title:'销量日增率',width:'13%',align:'center',sortable:true},
