                            ...
                            <form action="<?php echo U('add')?>" class="addform" method="post">
                                <dd>
                                    <ul class="web">
                                        <li>
                                            <strong>服务厂商：</strong>
<!--                                            <input type="text" class="text_input" name="name" placeholder='' datatype="s"/><span class="Validform_checktip " style="padding-left: 43px;">选择服务品牌-->
                                            <select name="brand_id">
                                                <?php foreach ($brandlist as $k=>$v):?>
                                                <option value="<?php echo $v["id"];?>"><?php echo $v["name"];?></optinn>
                                                <?php endforeach;?>
                                            </select>
                                            <span class="Validform_checktip " style="padding-left: 43px;">选择服务品牌
                                            </span>
                                        </li>
                                        <li>
                                            <strong>状态：</strong>
