...
<div class="content">
	<div class="site">
		 <a href="#">商品管理</a> > <a href="javascript:location.replace(location.href);">资质证书</a>
	</div>
...
<!--表格js-->
	...
	$(function(){	
		dom.datagrid({   
			...
			columns:[[
				{field:'name',title:'品牌名称',width:'80%',halign:'center',align:'center'},
				{field:'none',title:'操作',width:'20%',halign:'center',align:'center',
					formatter:function(value,row,index){
						var edithtml = '<a href="'+editurl+'&id='+row.id+'">详情</a>&nbsp;&nbsp;&nbsp;&nbsp;';
