    ...
    $(function(){
        dom.datagrid({
            ...
            columns:[[
                ...
                {field:'g_name',title:'产品名',width:'17%',halign:'center',align:'center'},
                {field:'c_name',title:'全部分类',width:'9%',halign:'center',align:'center'},
                {field:'bid',title:'品牌名',width:'9%',halign:'center',align:'center',
                ...
                {field:'display_hit',title:'显示人气',width:'10%',halign:'center',align:'center',sortable:true},
                {field:'sale_rate',title:'销量日增率',width:'10%',halign:'center',align:'center',sortable:true},
                // {field:'real_sale',title:'真实销量',width:'10%',halign:'center',align:'center',sortable:true},
                {field:'hit_rate',title:'人气日增率',width:'10%',halign:'center',align:'center',sortable:true},
                {field:'sale_natu_rate',title:'销量增长率',width:'10%',halign:'center',align:'center'},
                {field:'hit_natu_rate',title:'人气增长率',width:'10%',halign:'center',align:'center'}
                // {field:'real_hit',title:'真实人气',width:'10%',halign:'center',align:'center',sortable:true},
                // {field:'natu_rat',title:'自然增长率',width:'8%',halign:'center',align:'center',sortable:true}
            ]],
