...
<!--表格js-->
	...
	$(function(){	
		dom.datagrid({   
			...
			columns:[[
				{field:'name',title:'标签名称',width:'10%',halign:'center',align:'center'},
//				{field:'sort',title:'标签排序',width:'15%',align:'center',sortable:true,
...
//				},
				{field:'status',title:'是否显示',width:'5%',halign:'center',align:'center',sortable:true,
					formatter:function(value,row,index){
						...
						return statushtml;
                                ...
                                {field:'location',title:'显示位置',width:'10%',halign:'center',align:'left',
                                    formatter:function(value,row,index){
						if(value==1){
                                                    locationhtml = "左上";
                                                }
				...
				{field:'img',title:'图片路径',width:'65%',halign:'center',align:'left',
                                    formatter:function(value,row,index){
                                        var img_url="";
                                        if(value!=""){
                                            img_url='<a href='+'<?php echo IMG_URL;?>' +value+' target="_blank" title='+value+'>查看</a>';
                                        }
						var edithtml = '<?php echo IMG_URL;?>'+value+img_url;
