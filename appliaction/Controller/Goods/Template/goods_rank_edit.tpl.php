...
<div class="content">
    ...
    <div class="site">
        <a href="#">运营推广</a> > <a href="<?php echo U('lists')?>">产品排行榜管理</a> > 编辑排行榜信息
    </div>
    ...
    <div class="install mt10">
        <p>
            <a href="<?php echo  U('edit?type=1')?>"  <?php if ($type == 1) { echo "class='hover'"; }; ?>></a>
        </p>
        <dl>
            <div class="install mt10">
                <dl>
                    <form action="<?php echo U('Rank/edit')?>"  method="post" class="editform" autocomplete="off">
                        <dd>
                            <ul class="web">
                                <input type="hidden" class="text_input" name="id"  value="<?php echo $id; ?>"  />
                                <input type="hidden" class="text_input" name="goods_name"  value="<?php echo $name['g_name']; ?>"  />
                                <li>
                                    <strong>显示销量：</strong>
                                    <input type="text" class="text_input" name="display_sale"  value="<?php echo $day_data['display_sale'] ?>"  /><span style="padding-left: 80px;" >显示销量</span>
                                </li>
                                <li>
                                    <strong>销量日增率：</strong>
                                    <input type="text" class="text_input" name="sale_rate"  value="<?php echo $edit_data['sale_rate'] ?>"  datatype="n1-3"/><span style="padding-left: 80px;" class="Validform_checktip">销量日增率</span>
                                </li>
                                <li>
                                ...
                                <li>
                                    <strong>显示人气：</strong>
                                    <input type="text" class="text_input" name="display_hit"  value="<?php echo $day_data['display_hit'] ?>"  class="Validform_checktip"/><span style="padding-left: 80px;" >显示人气</span>
                                </li>
                                <li>
                                    <strong>人气日增率：</strong>
                                    <input type="text" class="text_input" name="hit_rate"  value="<?php echo $edit_data['hit_rate'] ?>"  datatype="n1-3"/><span style="padding-left: 80px;" class="Validform_checktip">人气日增率</span>
                                </li>
                                <li>
