                            ...
                            <form action="<?php echo U('edit') ?>" class="addform" method="post">
                                <dd>
                                    <ul class="web">
                                        <li>
                                            <strong>服务厂商：</strong>
<!--                                            <input type="text" class="text_input" name="name" placeholder='' datatype="s" value="" /><span class="Validform_checktip " style="padding-left: 43px;">设置商品规格名称　如：颜色-->
                                             <select name="brand_id">
                                                <?php foreach ($brandlist as $k=>$v):?>
                                                 <option value="<?php echo $v["id"];?>"<?php if($v["id"]==$info["brand_id"]) :?><?php echo 'selected';?><?php endif;?>><?php echo $v["name"];?></optinn> 
                                                <?php endforeach;?>
                                            </select>
                                                <span class="Validform_checktip " style="padding-left: 43px;">选择服务品牌</span>
