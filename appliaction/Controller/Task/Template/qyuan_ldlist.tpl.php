...
<div class="content">
    ...
    <div class="goods mt10">
        ...
        <div class="login mt10" style="border: none;border-right: 1px solid #e6e6e6;">
            <table id="qyuan_ldlists_grid" style="width:100%;"></table>
        </div>
        <div class="clear"></div>
    ...
    $(function(){
        dom.datagrid({
            ...
            columns:[[
                ...
                {field:'level',title:'级别',width:'14%',align:'center',sortable:true},
                ...
                {field:'none',title:'操作',width:'20%',halign:'center',align:'center',
                    formatter:function(value,row,index){
                        var shenhehtml = '<a href="'+shenheurl+'&idx='+row.idx+'" >查看审核</a>';
                        return shenhehtml;
                    }
                }
            ]]
